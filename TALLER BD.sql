...
ALTER TABLE CHECKIN
    ADD CONSTRAINT CK_TIPO CHECK (TIPO IN ('Fisico','Virtual'));
...
create or replace TRIGGER VUELOS__tggr
...
create or replace TRIGGER ITINERARIOS__tggr
...
create or replace TRIGGER PILOTOS__tggr
...
create or replace TRIGGER PROGRAMACION_TRIPULANTES__tggr
